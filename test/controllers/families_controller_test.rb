...
class FamiliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create family" do
    assert_difference('Family.count') do
      post families_url, params: { family: { birthday: @family.birthday, name: @family.name, relationship: @family.relationship } }
    end
  ...
  test "should update family" do
    patch family_url(@family), params: { family: { birthday: @family.birthday, name: @family.name, relationship: @family.relationship } }
